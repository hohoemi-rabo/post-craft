...
import { geminiImageGen } from '@/lib/gemini'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { style, aspectRatio, characterId, sceneDescription, postId } = body
    ...
    // Get character description if characterId is provided
    if (characterId) {
    ...
    const result = await geminiImageGen.generateContent(prompt)
